...
class Login extends StatefulWidget {
  final String lotsrcr;
  const Login({Key? key, required this.lotsrcr}) : super(key: key);
  @override
...
class _MyPhoneState extends State<Login> {
  ...
  var loading = false;
  var loading2 = false;
  List<String> items = ['المرحلة 3', 'المرحلة 2', 'المرحلة 1'];
  ...
  Registrion_use(name_customer, phone, context) async {
    setState(() {
      loading = true;
    });
    ...
    databaseReference
        .child(phone)
        .child(myKey!)
        .set({'id': myKey, "question": name_customer});
                  ...
                  : () async {
                      ...
                      if (countryController.text.toString().isEmpty) {
                        Fluttertoast.showToast(
                          ...
                          .isEmpty) {
                        Fluttertoast.showToast(
                          msg: 'الرجاء اختيار المرحلة ؟',
                          toastLength: Toast.LENGTH_SHORT,
                        );
                      } else {
                        Registrion_use(countryController.text.toString(),
                            countryController_phone.text.toString(), context);
                      }
                    },
              child: (loading)
